...
class ChatAdapter(
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(user: User) {
            ...
            when {
                user.isBot -> { badge.visibility = View.VISIBLE; badge.text = "Bot"; badge.setTextColor(0xff34c759.toInt()); badge.setBackgroundColor(0x33000000) }
            ...
            when (user.lastMsgStatus) {
                ...
                "read" -> { msgStatusIcon.visibility = View.VISIBLE; msgStatusIcon.setImageResource(R.drawable.ic_check_read); msgStatusIcon.setColorFilter(0xff4fc3f7.toInt()) }
